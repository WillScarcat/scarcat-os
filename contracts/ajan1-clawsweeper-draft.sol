...
// posture as ajan1-WillTokenV5.sol: guardian multisig + timelock gates all
...
//     WillTokenV5.isAgent, but this should be tightened before mainnet.
...
contract ClawsweeperDraft {
    ...
    // Per-action round counter — same pattern as WillTokenV5.actionRound.
    ...
    // is guardian-gated exactly like WillTokenV5.isAgent.
    ...
    // ============ Guardian multisig + timelock core (identical pattern to WillTokenV5) ============
    ...
    // ============ Emergency pause — same low-friction/high-friction split as WillTokenV5 ============
