...
# available.
#
# UPDATED 2026-07-25 — Option B total rebrand: targets HoodSeekV1
# (renamed from WillTokenV5). No real holders existed under the old
# identity, so this is a fresh deploy under the new name/symbol
# (NAME="HoodSeek", SYMBOL="HOSE"), not a migration.
#
# Guardian handoff: HoodSeekV1 has no separate `owner` and no
# post-deploy "transfer to multisig" step (see ajan1-HoodSeekV1.sol
...
CONTRACT_SRC="$SCRIPT_DIR/ajan1-HoodSeekV1.sol"
CONTRACT_NAME="HoodSeekV1"
...
INITIAL_SUPPLY="${INITIAL_SUPPLY:-420690000000000000000000000000}" # 420.69B HOSE * 1e18
...
echo "GEREKMIYOR — HoodSeekV1'de owner kavrami zaten kaldirilmisti."
